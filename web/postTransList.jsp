                        ...
                        <form action="" method="get" name="" id="Form">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        while (++cnt <= upper && resultSet.next()) {
                                            ...
                                            out.println("<th>" + resultSet.getDate("p_hiredate") + "</th>");
                                            out.println("</tr>");
                                        }
                                        while (cnt <= upper) {
                                            out.println("<tr>");
                            ...
                            <div class="anniu">
                                <ul id="menu1">
                                    <li>
                                        <%
                                            out.println(String.format("<a href='%s' class='tbtn white'>上一页</a>", "table?name=postTransList&page=" + String.valueOf(curPage - 1)));
                                        %>
                                    ...
                                    <%
                                        ...
                                        for (int i = 1; i <= pageCount; i++) {
                                            if (i == curPage) out.println(String.format("<li><a href='%s' class='tbtn blue'>%s</a></li>", "table?name=postTransList&page=" + String.valueOf(i), String.valueOf(i)));
                                            else out.println(String.format("<li><a href='%s' class='tbtn white'>%s</a></li>", "table?name=postTransList&page=" + String.valueOf(i), String.valueOf(i)));
                                        }
                                    %>
                                    <li>
                                        <%
                                            out.println(String.format("<a href='%s' class='tbtn white'>下一页</a>", "table?name=postTransList&page=" + String.valueOf(curPage + 1)));
                                        %>
                                    </li>
                                </ul>
                            </div>
